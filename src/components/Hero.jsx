    ...
    <section id="home" className="relative min-h-[100svh] overflow-hidden bg-[#050605] text-white">
      ...
      <div className="relative min-h-[100svh] overflow-hidden px-5 pb-7 pt-24 md:hidden">
        ...
        <div className="absolute inset-x-5 bottom-6 z-40 rounded-[34px] border border-white/15 bg-white/[0.045] px-5 py-7 text-center backdrop-blur-md">
          ...
          <a
            href="#contact"
            className="mx-auto mb-7 inline-flex items-center gap-4 rounded-full px-8 py-4 text-[17px] font-bold text-[#071000]"
            style={{ background: '#4DDCFF', boxShadow: '0 18px 45px rgba(77,220,255,0.22)', textDecoration: 'none' }}
          >
            Let's Talk
            <span className="flex h-9 w-9 items-center justify-center rounded-full bg-white text-xl text-[#071000]">↗</span>
          </a>
